...
> Temporary fix: Disabling and re-enabling the scripted input restored log flow.
...
```bash
index=_internal log_level=ERROR source="/opt/splunk/var/log/splunk/splunkd.log" recycling
```
